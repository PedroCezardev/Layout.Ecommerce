      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2
            ...
            <div>
              <div className="mb-4">
                ...
                <p className="text-4xl xl:text-5xl font-bold
                  opacity-20 mb-2">Fone de Ouvidos</p>
                <Button
                  text="Navegar"
                  bgColor={"bg-primary"}
          ...
          to-brandYellow/90 text-white rounded-3xl relative h-[320px]
            ...
            <img src={Image2} alt="" className="w-[320px] absolute -right-4
              lg:top-[40px]"/>
          </div>
          {/* terceira coluna */}
          ...
          to-primary/90 text-white rounded-3xl relative h-[320px]
            ...
            <img src={Image3} alt="" className="w-[250px] absolute top-1/2
